...
[![GitHub stars](https://img.shields.io/github/stars/TanmayDebnath1346/Tanmay-portfolio?style=social)](https://github.com/TanmayDebnath1346/Tanmay-portfolio/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/TanmayDebnath1346/Tanmay-portfolio?style=social)](https://github.com/TanmayDebnath1346/Tanmay-portfolio/network/members)
...
*(Enable GitHub Pages in repository settings if not already deployed)*

## 📸 Screenshots

| Home Section | Projects Section | Technical Skills |
|--------------|------------------|--------------|
| ![Home](https://via.placeholder.com/600x400?text=Home+Section) | ![Projects](https://via.placeholder.com/600x400?text=Projects+Section) | ![Contact](https://via.placeholder.com/600x400?text=Contact+Section) |
...
- Name: Tanmay Debnath
- Email: tanmaydebnath1346@example.com (Update with your email)
- LinkedIn: linkedin.com/in/tanmaydebnath (Update with your LinkedIn)
- Twitter/X: @TanmayDebnath (Update with your Twitter/X)
- GitHub: @TanmayDebnath1346
